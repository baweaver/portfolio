...
date: "2018-04-15"
categories: []
tags: ["ruby", "patternmatching", "functional"]
description: "The story behind creating Qo, a Ruby gem that brings pattern matching and fluent querying using triple equals."
---
...
2. Does it match the right side with === ?
3. Is there a predicate method we can call, and does it return true?
