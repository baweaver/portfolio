...
When I say "problem" or "fire" I want to be specific about what I mean. A fire is something that is measurably costing your business. It could be lost revenue, lost customers, lost engineering hours, or even accumulated and deferred risk that's about to blow up. What it isn't are things like code that offends your stylistic preferences, missing abstractions, dependencies you wish were different, or a new framework you think things should be rewritten in. If you cannot connect it to a direct cost that someone outside of engineering would recognize and agree with, it goes on a wish list, not a triage board.
