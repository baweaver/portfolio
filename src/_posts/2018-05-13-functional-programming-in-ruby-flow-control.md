...
description: "Functional approaches to flow control in Ruby, moving beyond exceptions to monadic error handling."
---
...
Option.new(5)
# => #<Option:0x00007fb2ae99d0c8 @value=5>
```
...
# => #<Option:0x00007fb2b02748f8 @value=10>
```
